...
export default class PdfView extends Component {
  ...
  componentDidUpdate(prevProps) {
    // console.log("LOG: PdfView.js:, componentDidUpdate");
  ...
  _renderSeparator = () => {
    ...
    return <View style={this.props.horizontal ? onW : onH} />;
  };
  ...
  _onScaleChanged = (pinchInfo) => {
    ...
    // console.log("LOG: PdfView.js: scale", this.state.scale);
    // console.log("LOG: PdfView.js: _onScaleChanged", newScale);
    // console.log(
    //   "LOG: PdfView.js: _onScaleChanged: newContentOffset",
    //   newContentOffset
    // );
    ...
    this.setState({ scale: newScale, newContentOffset });
    // }, 1000);
